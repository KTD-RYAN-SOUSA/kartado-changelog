    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "device",
                    models.ForeignKey(to="scarface.Device", on_delete=models.CASCADE),
                ),
            ],
            bases=(models.Model,),
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        to="scarface.Device", through="scarface.Subscription"
                    ),
                ),
            ],
            bases=(models.Model,),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                to="scarface.Platform", on_delete=models.CASCADE, related_name="devices"
            ),
        ),
        migrations.AddField(
            model_name="device",
            ...
            field=models.ManyToManyField(
                to="scarface.Topic", through="scarface.Subscription"
            ),
        ),
