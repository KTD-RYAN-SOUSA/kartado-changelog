...
class ServicesPerformedDSRegularAnnex7(CCRReport):
    def __init__(
        self,
        uuids: List[str] = None,
        panel_id: str = "",
        ...
        self.limit_date_executed_at = 60
        self.select_option: int = 2
        self.options = [
            {"name": "Bom", "value": "1"},
        ...
        self.file_name_zip = "Anexo VII - Serviços Realizados DS - Regular_%s.zip"
...
@task
def ccr_services_performed_ds_regular_annex7_async_handler(reporter_dict):
    instance = ServicesPerformedDSRegularAnnex7.from_dict(reporter_dict)
    instance.export()
