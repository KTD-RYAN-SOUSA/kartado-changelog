...
class XlsxHandler(RoutineXlsxHandler):
    ...
    _EXPORT_NAME = "Rotineira_OAE"
    _TEMPLATE_FILE = "./fixtures/reports/routine_oae.xlsm"
    _LOGO_CELL = "A55:B57"
...
class RoutineOAE(RoutineARTESP):
...
@task
def ccr_report_routine_oae_async_handler(
    reporter_dict: dict,
):
    reporter: RoutineOAE = RoutineOAE.from_dict(reporter_dict)
    reporter.export()
