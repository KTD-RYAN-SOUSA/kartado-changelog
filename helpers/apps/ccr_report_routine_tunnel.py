...
class XlsxHandler(RoutineXlsxHandler):
    ...
    _EXPORT_NAME = "Rotineira_Túnel"
    _TEMPLATE_FILE = "./fixtures/reports/routine_tunnel.xlsm"
    _LOGO_CELL = "A55:B57"
    ...
    _SIMPLE_FORM_DATA_FIELDS = {
        ...
        "outrosElementos": "B51",
        "pavimentoVisual": "I5",
        "acostamentoVisual": "I8",
        "drenagemVisual": "I11",
        "guardaCorposVisual": "I14",
        "barreirasDefensas": "I17",
        "contencao": "I23",
        "iluminacao": "I26",
        "sinalizacao": "I28",
        "gabaritos": "I30",
...
class RoutineTunnel(RoutineARTESP):
...
@task
def ccr_report_routine_tunnel_async_handler(
    reporter_dict: dict,
):
    reporter: RoutineTunnel = RoutineTunnel.from_dict(reporter_dict)
    reporter.export()
