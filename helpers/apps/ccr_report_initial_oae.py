...
class XlsxHandler(InitialXlsxHandler):
    ...
    _EXPORT_NAME = "Inicial_OAE"
    _TEMPLATE_FILE = "./fixtures/reports/initial_oae.xlsm"
    _LOGO_CELL = "A55:B57"
...
class InitialOAE(InitialARTESP):
...
@task
def ccr_report_initial_oae_async_handler(
    reporter_dict: dict,
):
    reporter: InitialOAE = InitialOAE.from_dict(reporter_dict)
    reporter.export()
